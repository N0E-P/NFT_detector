// THIS IS A TEST FILE TO SAVE MORE ADRESSES IN MORALIS
        ...
        .then(mssg => {
          ...
          collector.on('end', collected => {
            ...
            const iUseMoralis = (async() => {
              ...
              console.log("Début de l'écriture dans allOwners...")
              while (nftOwners.next){
                nftOwners = await nftOwners.next()
                allOwners = allOwners + nftOwners
              }
              //const everyOwners = allOwners
              
              console.log(allOwners)

              
              // Save the NFT owners in the Moralis Database
              console.log("Les addresses sont dans allOwners. Début de la sauvegarde dans Moralis...")
